...
class BIP66Test(XcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # xcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and xcoind produces more specific reject
            # reasons.
