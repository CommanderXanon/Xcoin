...
# TestP2PConn: A peer we use to send messages to xcoind, and store responses.
...
class CompactBlocksTest(XcoinTestFramework):
    ...
    # This test actually causes xcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that xcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for xcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # xcoind will not send blocktxn responses for blocks whose height is
