...
This document provides guidelines for internationalization of the Xcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xcoin_en.ts` remains unchanged.
