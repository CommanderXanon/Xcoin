Xcoin Core version 0.17.1 is now available from:
  ...
  <https://xcoincore.org/bin/xcoin-core-0.17.1/>
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/xcoin/xcoin/issues>

To receive security and update notifications, please subscribe to:

  <https://xcoincore.org/en/list/announcements/join/>
...
- #14698 `ec71f06` Add xcoin-tx.exe into Windows installer (ken2812221)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/xcoin/).
