...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/xcoin/xcoin/pull/10340, but that change has been
    // postponed until after https://github.com/xcoin/xcoin/pull/10244 to
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-xcoin-address
 ...
 * https://xcointalk.org/?topic=54527, or
 * https://github.com/xcoin/xcoin/pull/1393.
 */
