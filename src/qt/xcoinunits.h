...
#ifndef XCOIN_QT_XCOINUNITS_H
#define XCOIN_QT_XCOINUNITS_H
...
public:
    ...
    /** Xcoin units.
      @note Source: https://en.xcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XCN,
