    ...
    mapper(0)
{
    ...
    ui->xcoinAtStartup->setToolTip(ui->xcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->xcoinAtStartup->setText(ui->xcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openXcoinConfButton->setToolTip(ui->openXcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
...
{
    /* Main */
    mapper->addMapping(ui->xcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openXcoinConfButton_clicked()
{
