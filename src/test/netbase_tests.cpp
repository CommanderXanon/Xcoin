...
{
    BOOST_CHECK(TestSplitHost("www.xcoincore.org", "www.xcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.xcoincore.org]", "www.xcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.xcoincore.org:80", "www.xcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.xcoincore.org]:80", "www.xcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:20430", "127.0.0.1", 20430));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:20430", "127.0.0.1", 20430));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:20430", "::ffff:127.0.0.1", 20430));
    BOOST_CHECK(TestSplitHost("[::]:20430", "::", 20430));
    BOOST_CHECK(TestSplitHost("::20430", "::20430", -1));
    BOOST_CHECK(TestSplitHost(":20430", "", 20430));
    BOOST_CHECK(TestSplitHost("[]:20430", "", 20430));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:20430", "127.0.0.1:20430"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:20430", "[::]:20430"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
