...
#ifndef XCOIN_TEST_SCRIPTNUM10_H
#define XCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Xcoin Core 0.10.0, for cross-comparison.
 */
public:
